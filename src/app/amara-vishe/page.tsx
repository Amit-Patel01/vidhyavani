      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center rounded-3xl bg-white border border-slate-200 p-8 sm:p-12 shadow-sm">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
            વર્ષા જાની દવે છેલ્લા ૧૫+ વર્ષોથી માધ્યમિક અને ઉચ્ચતર માધ્યમિક શિક્ષણ ક્ષેત્રે સમર્પિત સેવા આપી રહ્યા છે. તેમની સરળ, રસપ્રદ અને સંકલ્પનાત્મક શિક્ષણ પદ્ધતિ દ્વારા હજારો વિદ્યાર્થીઓએ બોર્ડ પરીક્ષાઓમાં ૯૦% થી વધુ ગુણ મેળવીને ઉત્કૃષ્ટ સફળતા હાંસલ કરી છે.
          </p>
